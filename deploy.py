...
os.system("gcloud functions deploy clean --region southamerica-east1 --entry-point clean --runtime python37 --trigger-http --allow-unauthenticated --timeout 120")
...
os.system("gcloud functions deploy clean_window --region southamerica-east1 --entry-point clean_window --runtime python37 --trigger-http --allow-unauthenticated --max-instances 7")
